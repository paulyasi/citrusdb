...
<td width=\"20%\" align=center><a href=\"index.php?load=newcustomer&type=base\"><img src=\"images/new-icon.png\" alt=\"$l_new\" border=0><br>$l_new</a></td>
...
";
print "<a href=\"logout.php\"><img src=\"images/logout-icon.png\" alt=\"$l_logout $user\" border=0><br>$l_logout $user</a><td><tr>";
