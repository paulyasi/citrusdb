...
// save information
  ...
  while ($line = @fgetcsv($fp, 4096)) {
	...
	"WHERE id = $billingid";
      ...
      // make a service record
      
      // look for the record seperator "-" in first char
      // of a line and reset the linecount when you 
      // find one	
      if ($line[0] == "-") {
	$linecount = 0;
	...
	service_message('added', $account_number, $serviceid, $myinsertid, NULL, NULL);
