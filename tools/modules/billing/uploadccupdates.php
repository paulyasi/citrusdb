...
// get the path_to_citrus
	...
	$myresult = $result->fields;
        ...
        copy($userfile, "$path_to_ccfile/newccupdates.txt");
	...
	print "<script language=\"JavaScript\">window.location.href =\"index.php?load=billing&tooltype=module&type=tools&importccupdates=on&submit=on\";</script>";
