...
// get the path_to_citrus
	...
	$newfile = "$path_to_ccfile/newfile.txt";
	...
	// redirect back to importcc page
	print "<script language=\"JavaScript\">window.location.href =\"index.php?load=importcc&type=tools&submit=on\";</script>";
