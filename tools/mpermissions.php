...
$query = "SELECT * FROM module_permissions WHERE modulename='$module' ".
  "ORDER BY user";
$DB->SetFetchMode(ADODB_FETCH_ASSOC);
$result = $DB->Execute($query) or die ("$l_queryfailed");

echo "<table cellpadding=5 cellspacing=1><tr bgcolor=\"#eeeeee\"><td>".
"<b>$l_modulename</b></td><td><b>$l_permission</b></td><td>".
"<b>$l_user/$l_groups</b></td><td><b>$l_remove</b></td></tr>";
...
while ($myresult = $result->FetchRow())
{
  ...
  print "<tr bgcolor=\"#eeeeee\"><td>$module</td><td>$permission</td><td>$name".
    "</td><td><a href=\"index.php?load=rpermissions&module=$module&type=tools".
    "&pid=$pid\">[ $l_remove ]</a></td></tr>";
}
