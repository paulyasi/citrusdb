...
class Setup_model extends CI_Model
{
    ...
    function __construct()
    {
        ...
        // get access to the database and config variables
        $CI =& get_instance();
    }
    ...
    public function setup_database()
    {
        ...
        echo "Setup CitrusDB Database:\n";
        echo "Database Host:";
        $this->database_hostname = fgets(STDIN);
        echo "Database Username:";
        $this->database_username = fgets(STDIN);
        echo "Database Password:";
        $this->database_password = fgets(STDIN);
        echo "Database Name:";
        $this->database_name = fgets(STDIN);
        $dsn = 'mysql://'.$this->database_username.':'.$this->database_password.'@'.$this->database_hostname.'/'.$this->database_name;
        $this->load->database($dsn);

        // dump the default schema data into the database
        $this->sqldump();
    ...
    /*
     * ------------------------------------------------------------------------
     *  initiliaze the database with the default sql schema
     * ------------------------------------------------------------------------
     */
    public function sqldump()
    {
        //TODO:use database forge class from codeigniter to change the schema to code

        //Create Database: `citrus3` 
        // $db['default']['database'] = 'citrus3';
        $this->dbforge->create_database($this->database_name);
        echo "Created $this->database_name";
