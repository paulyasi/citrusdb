...
<h3><?php echo lang('emailinvoices')?></h3>
<FORM ACTION="<?php echo $this->url_prefix?>/index.php/tools/billing/sendeinvoice" 
...
<FORM ACTION="<?php echo $this->url_prefix?>/index.php/tools/billing/sendeinvoice" 
METHOD="GET" name="form2" onsubmit="toggleOn();">
<table>
...
<td><?php echo lang('whatidwouldyouliketobill')?>:</td><td><input type=text name=billingid>
</td><tr>
<td></td><td><INPUT TYPE="SUBMIT" NAME="submit" value="<?php echo lang('submit')?>"></td>
</table></form>
