...
if ($ticketuser)
{
	...
	echo "<meta http-equiv=\"refresh\" content=\"300;url=$this->url_prefix/index.php/tickets/user/$ticketuser/$ticketdatetime\">";
}
elseif ($ticketgroup)
{
	$cookiename = $ticketgroup . 'datetime'; //groupnamedatetime
	setcookie($cookiename,$ticketdatetime,(time()+3600000),'/','',0);
	echo "<meta http-equiv=\"refresh\" content=\"300;url=$this->url_prefix/index.php/tickets/group/$ticketgroup/$ticketdatetime\">";
}
?>
