...
<form style="margin-bottom:0;" action="<?php echo $this->url_prefix?>/index.php/billing/savecollectionsnotice" name="form1" method=post>

<?php echo lang('send_collections_notice_question')?> <p>
