...
if (($userprivileges['manager'] == 'y') OR ($userprivileges['admin'] == 'y')) 
{
    echo "<br>".
        ...
        lang('refundreport')."</a> | ". 
        "<a href=\"$this->url_prefix/index.php/billing/turnoff/$billing_id\">".
        lang('turnoff')."</a> | ". 
        "<a href=\"$this->url_prefix/index.php/billing/waiting/$billing_id\">".
        lang('waiting')."</a> | ".
        "<a href=\"$this->url_prefix/index.php/billing/authorized/$billing_id\">".
        lang('authorized')."</a> | ". 
        "<a href=\"$this->url_prefix/index.php/billing/cancelwfee/$billing_id\">".
        lang('cancelwithfee')."</a> | ".
        "<a href=\"$this->url_prefix/index.php/billing/collections/$billing_id\">".
        lang('collections')."</a><br>".
        "<a href=\"$this->url_prefix/index.php/billing/createinvoice/$billing_id\">".
        lang('createinvoice')."</a> | ". 
        "<a href=\"$this->url_prefix/index.php/billing/cancelnotice/$billing_id\">".
        lang('cancel_notice')."</a> | ".
        "<a href=\"$this->url_prefix/index.php/billing/shutoffnotice/$billing_id\">".
        lang('shutoff_notice')."</a> | ".
        "<a href=\"$this->url_prefix/index.php/billing/collectionsnotice/$billing_id\">".
        lang('collections_notice')."</a>";
}
?>
