...
{
	print "<br><br>";
	print "<h4>".lang('areyousurecollections')."</h4>";
	print "<table cellpadding=15 cellspacing=0 border=0 width=720><td align=right width=360>";
	print "<form style=\"margin-bottom:0;\" action=\"$this->url_prefix/index.php/billing/savecollections\" METHOD=POST>";
	...
	print "<td align=left width=360><form style=\"margin-bottom:0;\" action=\"$this->url_prefix/index.php/billing\">";
