...
<FORM ACTION="<?php echo $this->url_prefix?>/index.php/reports/summary/view" 
...
<a href="<?php echo $this->url_prefix?>/index.php/reports/summary/file/<?php echo $organization_id?>">
