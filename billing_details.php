...
<body bgcolor="#eedddd" marginheight=0 marginwidth=1 leftmargin=1 rightmargin=0>
	...
	// get the billing_details for this account, the account number is stored in the corresponding billing record

	$query = "SELECT d.id d_id, d.billing_id d_billing_id, d.creation_date d_creation_date,
	d.user_services_id d_user_services_id, d.taxed_services_id d_taxed_services_id, 
