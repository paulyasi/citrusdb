...
CREATE TABLE IF NOT EXISTS `activity_log` (
  ...
  `record_type` enum('dashboard','customer','billing','service','support','creditcard','admin_general','admin_settings','admin_users','admin_groups','admin_modules','admin_billingtypes','admin_services','admin_taxrates','admin_taxedservices','admin_linkedservices') NOT NULL,
